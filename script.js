...
//complete
var tceClasses = ['Bladesinger Wizard<sub>tce</sub>','Artillerist Artificer<sub>tce</sub>','Battlesmith Artificer<sub>tce</sub>','Alchemist Artificer<sub>tce</sub>','Armorer Artificer<sub>tce</sub>','Beast Barbarian<sub>tce</sub>','Wild Magic Barbarian<sub>tce</sub>','Creation Bard<sub>tce</sub>','Eloquence Bard<sub>tce</sub>','Order Cleric<sub>tce</sub>','Peace Cleric<sub>tce</sub>','Twilight Cleric<sub>tce</sub>','Spore Druid<sub>tce</sub>','Star Druid<sub>tce</sub>','Wildfire Druid<sub>tce</sub>','Psi Warrior Fighter<sub>tce</sub>','Rune Knight Fighter<sub>tce</sub>','Mercy Monk<sub>tce</sub>','Astral Self Monk<sub>tce</sub>','Glory Paladin<sub>tce</sub>','Watcher Paladin<sub>tce</sub>','Fey Wanderer Ranger<sub>tce</sub>','Swarmkeeper Ranger<sub>tce</sub>','Phantom Rogue<sub>tce</sub>','Soulknife Rogue<sub>tce</sub>','Abberant Mind Sorcerer<sub>tce</sub>','Clockwork Soul Sorcerer<sub>tce</sub>','Genie Warlock<sub>tce</sub>','Fathomless Warlock<sub>tce</sub>'];
var tceBackgrounds = [];
var tceRaces = [];
